...
class BookmarksControllerCell: UICollectionViewCell {
...
extension BookmarksControllerCell: UICollectionViewDelegate, UICollectionViewDataSource {
        
    func collectionView(_ collectionView: UICollectionView, numberOfItemsInSection section: Int) -> Int {
        itemsTest[section].aImage.count
    }
        
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "BookmarksImageCollectionViewCell", for: indexPath as IndexPath) as! BookmarksImageCollectionViewCell
        cell.imageAuto.ddddownloadedFrom(link: "\(itemsTest[indexPath.section].aImage)")
        return cell
    }
}
...
func ddddownloadedFrom(url: URL, contentMode mode: UIView.ContentMode = .scaleAspectFit) {
    contentMode = mode
...
func ddddownloadedFrom(link: String, contentMode mode: UIView.ContentMode = .scaleAspectFit) {
